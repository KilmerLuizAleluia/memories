...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post memories_url, params: { memory: { date: @memory.date, description: @memory.description, local: @memory.local, user_id: @memory.user_id, weather: @memory.weather } }
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { date: @memory.date, description: @memory.description, local: @memory.local, user_id: @memory.user_id, weather: @memory.weather } }
